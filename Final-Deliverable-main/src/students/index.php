...
<head>
    ...
    <title>eLEARNING | Student Dashboard</title>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="../assets/profile_images/<?= $std['image'] ?>" class="user-image"
                                    alt="User Image">
                                <span class="hidden-xs"><?= $std['name'] ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="../assets/profile_images/<?= $std['image'] ?>" class="img-circle"
                                        alt="User Image">
                                    <p>
                                        <?= $std['name'] ?>
                                    </p>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="../assets/profile_images/<?= $std['image'] ?>" style="height: 45px;"
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="index.php?page=announcements">
                            <i class="fa fa-bullhorn"></i> <span>Announcements</span> <span
...
<df-messenger intent="WELCOME" chat-title="TrainingCompanyAgent" agent-id="36a630a5-4b8c-4285-b8a9-9d6859103ab7"
